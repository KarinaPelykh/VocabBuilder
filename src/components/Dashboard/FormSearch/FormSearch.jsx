  ...
  return (
    <div className=" flex mb-[8px] md:mb-[0px]  md:mr-[8px]">
      <form className=" w-[100%] relative  md:mr-[8px] ">
        <input
          className=" w-[100%]  outline-none border border-[#DBDBDB] py-[12px] px-[24px] bg-transparent rounded-[12px]  placeholder:text-black placeholder:font-fixelMedium md:w-[274px]"
          type="text"
          name="text"
